...
class PdfFile {
    ...
    public PointF mapDeviceCoordToPageCoord(int pageIndex, int startX, int startY, int sizeX, int sizeY,
            int deviceX, int deviceY) {
        int docPage = documentPage(pageIndex);
        return pdfiumCore.mapDeviceCoordsToPage(pdfDocument, pageIndex,  startX, startY, sizeX, sizeY, 0, deviceX, deviceY);
    }
